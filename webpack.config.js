...
// Define envs for all targets
const OPEN_LOGIN_CLIENT_ID =
  process.env.WIGWAM_OPEN_LOGIN_CLIENT_ID || "";

const WEBSITE_ORIGIN = process.env.WIGWAM_WEBSITE_ORIGIN || "https://secexplorer.io";

const STATIC_CDN = process.env.WIGWAM_STATIC_CDN || "https://secexplorer.io";

const staticTemplateOptions = {
  website: WEBSITE_ORIGIN,
  envBadge: ENV_SHORT === "production" ? "" : `[${ENV_SHORT}] `,
