...
const AttentionContent = [
  {
    ...
    content: (
      <>
        <p className="mb-2">
          It is not possible to recover the current profile password. Smart
          Energy Chain is <strong>non-custodial</strong> software. The user is
          the only one who knows the password.
        </p>
  ...
  },
  {
    ...
    content: (
      <p>
        SEC does not have a built-in function to reset the application. We
        recommend using{" "}
